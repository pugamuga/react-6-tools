...
const WindowForTwo = () => {
  return (
    <motion.div
      ...
      className="absolute h-[320px] lg:h-[400px] w-[300px] lg:w-[400px]  bg-white rounded-xl shadow-2xl flex justify-center items-center  "
    >
      ...
      <div className="">
        <img
          src={apeGif}
          className=" mx-auto lg:scale-100 scale-[85%]  rounded-lg"
        />
        <div>
          <h1 className="text-3xl lg:text-4xl text-center my-8 font-bold text-sky-800 ">
            🐵Manki respect🐵
          </h1>
        </div>
      </div>
